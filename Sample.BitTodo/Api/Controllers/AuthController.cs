...
using Sample.BitTodo.Api.Resources;
using Sample.BitTodo.Api.Models.Account;
using Sample.BitTodo.Shared.Dtos.Account;
using Sample.BitTodo.Api.Models.Emailing;

namespace Sample.BitTodo.Api.Controllers;
...
public partial class AuthController : AppControllerBase
{
    ...
    private async Task SendConfirmationEmail(SendConfirmationEmailRequestDto sendConfirmationEmailRequest, User user, CancellationToken cancellationToken)
    {
        ...
        var result = await _fluentEmail
            ...
            .UsingTemplateFromEmbedded("Sample.BitTodo.Api.Resources.EmailConfirmation.cshtml",
        ...
        , CancellationToken cancellationToken)
    {
        ...
        var result = await _fluentEmail
            ...
            .UsingTemplateFromEmbedded("Sample.BitTodo.Api.Resources.ResetPassword.cshtml",
